...
void attackFleet(char **my_map_def, char **map_atk, char **map_def, int *l, int *c, Fleet *my_fleet, Fleet *p_fleet, int *adversary_life, int *x, int *y, int player, int *alert_tab);
...
void flemme(char **map, char **map_att, int *l, int *c, Fleet *p_fleet, int *x, int *y, int player, int *alert_tab);
